    ...
    public function run(): void
    {
        ...
        $entries = [
            [
                'id' => 'JE-001',
                'date' => '2026-03-01',
                'desc' => 'Rent received — Sarah Rutto (A-101)',
                'ref' => 'RENT-A101-Mar2026',
                'status' => 'posted',
            ...
            [
                'id' => 'JE-002',
                'date' => '2026-03-01',
                'desc' => 'Rent received — Amina Musa (B-201)',
                'ref' => 'RENT-B201-Mar2026',
                'status' => 'posted',
            ...
            [
                'id' => 'JE-003',
                'date' => '2026-03-17',
                'desc' => 'Maintenance: Broken water pipe (D-401)',
                'ref' => 'MAINT-TK-001',
                'status' => 'posted',
            ...
            [
                'id' => 'JE-004',
                'date' => '2026-03-05',
                'desc' => 'KPLC electricity bill — March 2026',
                'ref' => 'UTIL-KPLC-MAR2026',
                'status' => 'posted',
            ...
            [
                'id' => 'JE-005',
                'date' => '2026-03-19',
                'desc' => 'Monthly depreciation — March 2026',
                'ref' => 'DEP-MAR2026',
                'status' => 'posted',
            ...
            [
                'id' => 'JE-006',
                'date' => '2026-03-19',
                'desc' => 'Insurance premium — Q1 2026',
                'ref' => 'INS-Q1-2026',
                'status' => 'draft',
        ...
        foreach ($entries as $e) {
            $je = JournalEntry::updateOrCreate(
                ['property_id' => $propertyId, 'entry_number' => $e['id']],
                [
                    'entry_date'   => $e['date'],
                    'description'  => $e['desc'],
                    'reference'    => $e['ref'],
            ...
            JournalLine::where('journal_entry_id', $je->id)->delete();
