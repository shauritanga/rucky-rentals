    ...
    public static function entities(): array
    {
        return [
            ...
            'units' => [
                ...
                'columns' => [
                    'unit_number' => ['label' => 'Unit Number', 'type' => 'string'],
                    'floor' => ['label' => 'Floor', 'type' => 'string'],
                    ...
                    'electricity_type' => ['label' => 'Electricity Type', 'type' => 'string'],
                    'created_at' => ['label' => 'Created At', 'type' => 'date'],
                ],
            ],
            'tenants' => [
                ...
                'columns' => [
                    ...
                    'tenant_type' => ['label' => 'Tenant Type', 'type' => 'string'],
            ...
            'invoices' => [
                ...
                'columns' => [
                    ...
                    'unit_ref' => ['label' => 'Unit Ref', 'type' => 'string'],
            ...
            'journal_entries' => [
                ...
                'columns' => [
                    ...
                    'source_type' => ['label' => 'Source Type', 'type' => 'string'],
                ],
            ],
            'journal_lines' => [
                'label' => 'Journal Lines',
            ...
            'meter_readings' => [
                ...
                'columns' => [
                    ...
                    'recorded_by' => ['label' => 'Recorded By', 'type' => 'string'],
                ],
            ],
            'electricity_sales' => [
