...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('force.password.change')->group(function () {
        ...
        Route::resource('clearance', ClearanceController::class)->only(['index', 'store', 'update', 'destroy']);
        Route::post('clearance/{clearance}/items', [ClearanceController::class, 'storeItem'])->name('clearance.items.store');
        Route::patch('clearance/{clearance}/items/{item}', [ClearanceController::class, 'updateItem'])->name('clearance.items.update');
        Route::delete('clearance/{clearance}/items/{item}', [ClearanceController::class, 'destroyItem'])->name('clearance.items.destroy');
        Route::post('clearance/{clearance}/finalize', [ClearanceController::class, 'finalize'])->name('clearance.finalize');
        Route::get('clearance/{clearance}/pdf', [ClearanceController::class, 'downloadCertificate'])->name('clearance.pdf');
        ...
        Route::get('invoices/due-reminders', [InvoiceController::class, 'dueReminders'])->name('invoices.due-reminders');
        ...
        Route::put('reports/builder/templates/{reportTemplate}', [ReportBuilderController::class, 'updateTemplate'])->name('reports.templates.update');
        Route::delete('reports/builder/templates/{reportTemplate}', [ReportBuilderController::class, 'destroyTemplate'])->name('reports.templates.destroy');
        ...
        Route::patch('superuser/properties/{property}', [SuperuserController::class, 'updateProperty'])->name('superuser.properties.update');
