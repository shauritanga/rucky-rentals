...
export default function Profile() {
  ...
  const [email, setEmail] = useState('james@velour.co.tz');
  const [phone, setPhone] = useState('+255 754 111 222');
  const [bio, setBio] = useState('Managing all operations for Velour Heights since 2022. Responsible for leases, maintenance coordination and tenant relations.');
  ...
  return (
    <AppLayout title="My Profile" subtitle="James Mwangi">
          ...
          <div className="profile-left-col">
            <div className="card">
              <div className="profile-avatar-card-head">
                ...
                <div className="profile-role-text">Property Manager</div>
                <div className="profile-property-text">Velour Heights</div>
            ...
            <div className={`prof-tab-content ${tab === 'personal' ? 'active' : ''}`}>
              <div className="card">
                ...
                <div className="profile-form-grid">
                  ...
                  <div><label className="form-label">Role</label><input className="form-input" type="text" value="Property Manager" readOnly style={{ opacity: .55, cursor: 'default' }} /></div>
                  <div><label className="form-label">Assigned Property</label><input className="form-input" type="text" value="Velour Heights" readOnly style={{ opacity: .55, cursor: 'default' }} /></div>
