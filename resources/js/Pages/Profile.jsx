          ...
          <div className="profile-left-col">
            <div className="card">
              <div className="profile-avatar-card-head">
                ...
                <div className="profile-property-text">{user?.property_name || 'Assigned Property'}</div>
            ...
            <div className={`prof-tab-content ${tab === 'personal' ? 'active' : ''}`}>
              <div className="card">
                ...
                <div className="profile-form-grid">
                  ...
                  <div><label className="form-label">Assigned Property</label><input className="form-input" type="text" value={user?.property_name || '—'} readOnly style={{ opacity: .55, cursor: 'default' }} /></div>
              ...
              <div className="card" style={{ marginBottom: 14 }}>
                ...
                <div style={{ padding: 20 }}>
                  <div className="profile-twofa-box">
                    <div>
                      <div style={{ fontSize: 13.5, fontWeight: 500 }}>Email One-Time Passcode</div>
                      <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 2 }}>
                        When the global security setting is enabled, you will receive a 6-digit email code after entering your password.
                      </div>
                    </div>
                  </div>
                </div>
