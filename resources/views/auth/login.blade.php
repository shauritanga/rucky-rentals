            ...
            <div class="login-form-wrap">
                ...
                <form id="loginForm" method="POST" action="{{ route('login.attempt') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-wrap">
                            ...
                            <button class="pw-toggle" onclick="togglePassword()" type="button" tabindex="-1">
                                <svg id="pwIcon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="form-options">
                        <label class="remember-wrap"><input type="checkbox" id="rememberMe" name="remember" value="1" {{ old('remember', true) ? 'checked' : '' }}>Remember me</label>
                    ...
                    <button class="btn-login" id="loginBtn" type="submit">
                        ...
                        <svg id="loginArrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
